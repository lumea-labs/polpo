    ...
    <div ref={rootRef} className="relative inline-block">
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute right-0 top-[calc(100%+4px)] z-50 w-[320px] overflow-hidden rounded-md border border-border bg-popover shadow-xl">
                    ...
                    {list.map((m) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {m.context ? (
                            <span
                              className="ml-auto shrink-0 font-mono text-[10px] text-muted-foreground/40"
                              data-tabular
                            >
