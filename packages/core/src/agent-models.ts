...
export const AUDIO_MODEL_CATALOG: readonly AudioModelDefinition[] = [
  ...
  },
  {
    ...
    credentialService: "deepgram",
    language: "en-US",
    description: "Clear, energetic US English voice for customer service and IVR.",
  },
  {
    ...
    credentialService: "deepgram",
    language: "en-US",
    description: "Friendly, natural US English voice for support and conversational agents.",
  },
  {
    id: "deepgram/aura-2-apollo-en",
    name: "Aura 2 Apollo",
    provider: "deepgram",
    capability: "speech",
    routing: "direct",
    credentialService: "deepgram",
    language: "en-US",
    description: "Confident, casual US English voice.",
  },
  {
